    ...
    if (isValid) {
      ...
      try {
        ...
        if (_pickedImage != null) {
          // Upload the image (wait for completion)
        ...
        // Update Firestore with the correct imageUrl
        await FirebaseFirestore.instance
          ...
          'imageUrl':  _pickedImage == null ? widget.imageUrl : imageUri.toString(), // Use existing imageUrl if no new image uploaded
                              ...
                              child: Row(
                                ...
                                children: [
                                  ButtonsWidget(
                                    ...
                                    backgroundColor: Colors.red.shade700, textColor: Colors.white, iconColor: Colors.white,
                                  ),
                                  ButtonsWidget(
                                    onPressed: () {
                                      _updateProduct();
                                    ...
                                    backgroundColor: Colors.blue,textColor: Colors.white, iconColor: Colors.white,
                                  ),
                                ],
                              ),
                            )
